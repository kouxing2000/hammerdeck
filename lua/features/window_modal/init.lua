...
local function arrangerFor(ctx)
    ...
    function st.toggleMode()
        ...
        st.mode = ctx.modal {
            ...
            bindings = {
                { key = "a", fn = function() move(-1, 0) end },
                { key = "d", fn = function() move(1, 0) end },
                { key = "w", fn = function() move(0, -1) end },
                { key = "s", fn = function() move(0, 1) end },
                ...
                { mods = { "shift" }, key = "h", fn = function() resize(-1, 0) end },
                { mods = { "shift" }, key = "l", fn = function() resize(1, 0) end },
                { mods = { "shift" }, key = "k", fn = function() resize(0, -1) end },
                { mods = { "shift" }, key = "j", fn = function() resize(0, 1) end },
