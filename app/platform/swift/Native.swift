...
final class Native {
    ...
    func installBindings() {
        ...
        let fns2: [String: LuaState.Function] = [
            ...
            "chooser_query": { L in MainActor.assumeIsolated { Native.shared.chooserQuery(L) } },
            ...
            "outline_set_filled": { L in MainActor.assumeIsolated { Native.shared.outlineSetFilled(L) } },
            "outline_set_clip":  { L in MainActor.assumeIsolated { Native.shared.outlineSetClip(L) } },
            "outline_clear_clip": { L in MainActor.assumeIsolated { Native.shared.outlineClearClip(L) } },
