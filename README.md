...
Every feature ships **off by default** except **Confirm Shortcut Presses**, which is on from a fresh install -- switch any other on in Settings and bind it to any trigger.
...
<p align="center">
  <img src=".github/assets/settings.png" alt="Hammerdeck Settings: the feature list with each feature's bound hotkey on the left, and on the right Bing Daily Wallpaper's generated options plus its trigger editor set to Every N minutes, interval 180" width="900">
</p>
