...
**25 features**, each off by default, switched on in Settings and bindable to any trigger.
...
Half the catalog runs with **no macOS permission at all**. The rest ask only when
you first use them:
